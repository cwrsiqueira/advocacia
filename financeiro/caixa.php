				...
				<div class="row">
					...
					<div class="col-sm-10">
						<div class="form-group">
							...
							<input type="text" name="conta" class="form-control" placeholder="Contra Partida" required>
				...
				<div class="row">
					<div class="col-sm">
						<div class="form-group">
							...
							<input type="hidden" name="data-pagamento" id="data-pagamento" value="<?php echo $agora; ?>">
						</div>
					</div>
					<div class="col-sm data-vencimento">
						<div class="form-group">
							<label for="data-vencimento">Data do Vencimento:</label>
							<input type="date" name="data-vencimento" id="data-vencimento" value="" class="form-control" min="" disabled>
						</div>
					</div>
					<div class="col-sm">
						<div class="form-group">
		...
		<div class="col-md-9 col-sm-12">
			...
			<div class="float-right mr-4">
				<form id="frm" class="form-inline my-2 my-lg-0" method="post">
					...
					<input type="hidden" name="pagina" value="<?php echo $pagina; ?>">
					<input type="hidden" name="id_conta" value="<?php echo @$_GET['id_conta']; ?>">
					<input type="hidden" name="conta_nome" value="<?php echo @$_GET['nome_conta']; ?>">

					<a class="btn btn-sm btn-secondary m-3" href="<?php echo BASE_URL; ?>financeiro/index.php?acao=caixa">Limpar Buscas</a>
					...
					<input class="form-control form-control-sm mr-sm-2" type="date" name="dataFinal" id="dataFinal" value="<?php echo $agora ?>" min="">
...
<script>
	$(function(){
		...
		// SCRIPT PARA DEIXAR A DATA DE PAGAMENTO IGUAL A DATA DE LANÇAMENTO
		$('#data-lancamento').change(function(){
			$('#data-pagamento').attr('max', hoje);
			$('#data-pagamento').val($(this).val());		
		});
			...
			$(document).on('click', '#editar_lancamento', function(e){
				...
				$.ajax({
					...
					success: function(json){
						...
						$('#movimento').val(json.movimento).focus();
						$('#tipo').val(json.tipo);
